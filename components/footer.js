                        ...
                        <div id="legal-disclaimer" class="hidden border-t border-gray-700 pt-6 mt-6">
                            <div class="max-w-4xl mx-auto">
                                ...
                                <div class="text-xs text-gray-400 space-y-3 leading-relaxed">
                                    ...
                                    <p>
                                        <strong class="text-gray-300">EA Regulations Compliance:</strong> All waste transactions conducted through WasteMatch are subject to UK Environment Agency (EA) waste regulations. Users are responsible for ensuring they hold appropriate waste carrier licenses, waste transfer notes are completed correctly, and all waste is handled in compliance with EA requirements. WasteMatch provides compliance tools but does not guarantee regulatory compliance.
                                    </p>
                                    <p>
